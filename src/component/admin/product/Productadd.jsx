...
const Productadd = () => {
  ...
  return (
    <div>
      <h2 className="text-green-600 text-center underline mt-16">
        Add Product
      </h2>
        ...
        <div className="flex-col ms-8 mt-6 border-2  border-green-600 w-[400px] h-[620px]">
          ...
          <div className="flex justify-center items-center sm:ml-0 ml-2 ">
            <img
              src={mainimage}
              alt="loading..."
              className="bg-slate-100 w-[60px] h-[60px] sm:w-[100px] sm:h-[100px]  m-2"
            />
          ...
          <div className="flex gap-2">
            ...
            <FileBase64
              onDone={(res) => setImage([...image, { image: res.base64 }])}
            />
          </div>
          <div className="ms-6 mt-3 p-2">
            <button
              className="border-2 border-green-800 rounded ms-20 mt-2"
              type="submit"
            >
              Add Product
            </button>
